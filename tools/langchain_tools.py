...
class AsyncPokeapiTool(BaseTool):
    ...
    description: Literal["Tool to fetch essential Pokémon data from PokéAPI."] = "Tool to fetch essential Pokémon data from PokéAPI."
...
class AsyncPokeapiToolWithTypes(BaseTool):
    ...
    description: Literal["Tool to fetch essential Pokémon data from PokéAPI including type damage relations."] = "Tool to fetch essential Pokémon data from PokéAPI including type damage relations."
    args_schema: Type[BaseModel] = PokemonInput
