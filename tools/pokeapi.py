...
class PokeAPIService:
    ...
    def __init__(self, cache_size: int = 100):
        ...
        # Create an async client that can be reused
    ...
    async def get_pokemon_data(self, pokemon_name: str, get_type_data: bool = False) -> Dict[str, Any]:
    ...
    async def _fetch_pokemon_data(self, pokemon_name: str, get_type_data: bool = False) -> Dict[str, Any]:
